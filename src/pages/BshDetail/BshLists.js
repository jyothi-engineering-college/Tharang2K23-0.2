const AdLists = [
  {
    id: 1,
    name: "G-VERSE",
    imgSrc: "/assets/BSH/g.jpg",
    heading: "G-VERSE",
    desc: "Our event consist of PlayStation5(PS5).PS5 Gaming is an event that combines the exciting world of PlayStation 5 gaming.During this event, participants can explore the latest advancements in gaming technology and experience a fusion of cutting-edge hardware and immersive gameplay.",
  ...
  
  {
    id: 4,
    name: "PhotoBooth",
    imgSrc: "/assets/BSH/Picsart.jpg",
    heading: "SNAP n SMILE",
    rule1: "Join us for a picture-perfect experience at our photobooth.",
    rule2: "Capture your unforgettable moments.",
    rule3: "Available at ADM 306 on 10th & 11th November.",
    regFee: "40",
    contact: "stevevijay.cs23@jecc.ac.in",
    redirectLink: `/events/BshDetail/PhotoBooth`,
  },{
    id: 2,
    name: "PLAYPALOOZA",
