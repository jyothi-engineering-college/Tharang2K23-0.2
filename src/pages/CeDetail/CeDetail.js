...
import classes from "./CeDetail.module.css";
import Background from "../../UI/Background";
import CeLists from "./CeLists";
...
const CeDetail = () => {
  ...
  const culturalDetail = CeLists.filter(
    (event) => params.id === event.name
  );

  // const filteredDetail = CeLists.filter((event) => params.id === event.name)
