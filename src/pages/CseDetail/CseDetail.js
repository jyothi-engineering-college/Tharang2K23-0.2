...
import classes from "./CseDetail.module.css";
import Background from "../../UI/Background";
import CseLists from "./CseLists";
...
const CseDetail = () => {
  ...
  const culturalDetail = CseLists.filter(
    (event) => params.id === event.name
  );

  // const filteredDetail = CseLists.filter((event) => params.id === event.name)
