...
import classes from "./MrDetail.module.css";
import Background from "../../UI/Background";
import MrLists from "./MrLists";
...
const MrDetail = () => {
  ...
  const culturalDetail = MrLists.filter(
    (event) => params.id === event.name
  );

  // const filteredDetail = MrLists.filter((event) => params.id === event.name)
