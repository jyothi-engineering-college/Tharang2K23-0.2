...
import classes from "./RaDetail.module.css";
import Background from "../../UI/Background";
import RaLists from "./RaLists";
...
const RaDetail = () => {
  ...
  const culturalDetail = RaLists.filter(
    (event) => params.id === event.name
  );

  // const filteredDetail = RaLists.filter((event) => params.id === event.name)
