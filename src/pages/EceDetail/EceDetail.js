...
import classes from "./EceDetail.module.css";
import Background from "../../UI/Background";
import EceLists from "./EceLists";
...
const EceDetail = () => {
  ...
  const culturalDetail = EceLists.filter(
    (event) => params.id === event.name
  );

  // const filteredDetail = EceLists.filter((event) => params.id === event.name)
