...
import classes from "./EeeDetail.module.css";
import Background from "../../UI/Background";
import EeeLists from "./EeeLists";
...
const EeeDetail = () => {
  ...
  const culturalDetail = EeeLists.filter(
    (event) => params.id === event.name
  );

  // const filteredDetail = EeeLists.filter((event) => params.id === event.name)
