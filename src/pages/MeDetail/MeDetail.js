...
import classes from "./MeDetail.module.css";
import Background from "../../UI/Background";
import MeLists from "./MeLists";
...
const MeDetail = () => {
  ...
  const culturalDetail = MeLists.filter(
    (event) => params.id === event.name
  );

  // const filteredDetail = MeLists.filter((event) => params.id === event.name)
